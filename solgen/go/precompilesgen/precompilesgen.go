...
// ArbMultiGasConstraintsTypesResourceConstraint is an auto generated low-level Go binding around an user-defined struct.
type ArbMultiGasConstraintsTypesResourceConstraint struct {
	Resources            []ArbMultiGasConstraintsTypesWeightedResource
	AdjustmentWindowSecs uint32
	TargetPerSec         uint64
	Backlog              uint64
}

// ArbMultiGasConstraintsTypesWeightedResource is an auto generated low-level Go binding around an user-defined struct.
type ArbMultiGasConstraintsTypesWeightedResource struct {
	Resource uint8
	Weight   uint64
}
...
// OverwriteContractCode is a paid mutator transaction binding the contract method 0x1be250d6.
//
// Solidity: function overwriteContractCode(address target, bytes newCode) returns(bytes oldCode)
func (_ArbDebug *ArbDebugTransactor) OverwriteContractCode(opts *bind.TransactOpts, target common.Address, newCode []byte) (*types.Transaction, error) {
	return _ArbDebug.contract.Transact(opts, "overwriteContractCode", target, newCode)
}

// OverwriteContractCode is a paid mutator transaction binding the contract method 0x1be250d6.
//
// Solidity: function overwriteContractCode(address target, bytes newCode) returns(bytes oldCode)
func (_ArbDebug *ArbDebugSession) OverwriteContractCode(target common.Address, newCode []byte) (*types.Transaction, error) {
	return _ArbDebug.Contract.OverwriteContractCode(&_ArbDebug.TransactOpts, target, newCode)
}

// OverwriteContractCode is a paid mutator transaction binding the contract method 0x1be250d6.
//
// Solidity: function overwriteContractCode(address target, bytes newCode) returns(bytes oldCode)
func (_ArbDebug *ArbDebugTransactorSession) OverwriteContractCode(target common.Address, newCode []byte) (*types.Transaction, error) {
	return _ArbDebug.Contract.OverwriteContractCode(&_ArbDebug.TransactOpts, target, newCode)
}
...
// ArbFilteredTransactionsManagerMetaData contains all meta data concerning the ArbFilteredTransactionsManager contract.
var ArbFilteredTransactionsManagerMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"txHash\",\"type\":\"bytes32\"}],\"name\":\"addFilteredTransaction\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"txHash\",\"type\":\"bytes32\"}],\"name\":\"deleteFilteredTransaction\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"txHash\",\"type\":\"bytes32\"}],\"name\":\"isTransactionFiltered\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"txHash\",\"type\":\"bytes32\"}],\"name\":\"FilteredTransactionAdded\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"txHash\",\"type\":\"bytes32\"}],\"name\":\"FilteredTransactionDeleted\",\"type\":\"event\"}]",
}

// ArbFilteredTransactionsManagerABI is the input ABI used to generate the binding from.
// Deprecated: Use ArbFilteredTransactionsManagerMetaData.ABI instead.
var ArbFilteredTransactionsManagerABI = ArbFilteredTransactionsManagerMetaData.ABI

// ArbFilteredTransactionsManager is an auto generated Go binding around an Ethereum contract.
type ArbFilteredTransactionsManager struct {
	ArbFilteredTransactionsManagerCaller     // Read-only binding to the contract
	ArbFilteredTransactionsManagerTransactor // Write-only binding to the contract
	ArbFilteredTransactionsManagerFilterer   // Log filterer for contract events
}

// ArbFilteredTransactionsManagerCaller is an auto generated read-only Go binding around an Ethereum contract.
type ArbFilteredTransactionsManagerCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbFilteredTransactionsManagerTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ArbFilteredTransactionsManagerTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbFilteredTransactionsManagerFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ArbFilteredTransactionsManagerFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbFilteredTransactionsManagerSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ArbFilteredTransactionsManagerSession struct {
	Contract     *ArbFilteredTransactionsManager // Generic contract binding to set the session for
	CallOpts     bind.CallOpts                   // Call options to use throughout this session
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// ArbFilteredTransactionsManagerCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ArbFilteredTransactionsManagerCallerSession struct {
	Contract *ArbFilteredTransactionsManagerCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                         // Call options to use throughout this session
}

// ArbFilteredTransactionsManagerTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ArbFilteredTransactionsManagerTransactorSession struct {
	Contract     *ArbFilteredTransactionsManagerTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                         // Transaction auth options to use throughout this session
}

// ArbFilteredTransactionsManagerRaw is an auto generated low-level Go binding around an Ethereum contract.
type ArbFilteredTransactionsManagerRaw struct {
	Contract *ArbFilteredTransactionsManager // Generic contract binding to access the raw methods on
}

// ArbFilteredTransactionsManagerCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ArbFilteredTransactionsManagerCallerRaw struct {
	Contract *ArbFilteredTransactionsManagerCaller // Generic read-only contract binding to access the raw methods on
}

// ArbFilteredTransactionsManagerTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ArbFilteredTransactionsManagerTransactorRaw struct {
	Contract *ArbFilteredTransactionsManagerTransactor // Generic write-only contract binding to access the raw methods on
}

// NewArbFilteredTransactionsManager creates a new instance of ArbFilteredTransactionsManager, bound to a specific deployed contract.
func NewArbFilteredTransactionsManager(address common.Address, backend bind.ContractBackend) (*ArbFilteredTransactionsManager, error) {
	contract, err := bindArbFilteredTransactionsManager(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManager{ArbFilteredTransactionsManagerCaller: ArbFilteredTransactionsManagerCaller{contract: contract}, ArbFilteredTransactionsManagerTransactor: ArbFilteredTransactionsManagerTransactor{contract: contract}, ArbFilteredTransactionsManagerFilterer: ArbFilteredTransactionsManagerFilterer{contract: contract}}, nil
}

// NewArbFilteredTransactionsManagerCaller creates a new read-only instance of ArbFilteredTransactionsManager, bound to a specific deployed contract.
func NewArbFilteredTransactionsManagerCaller(address common.Address, caller bind.ContractCaller) (*ArbFilteredTransactionsManagerCaller, error) {
	contract, err := bindArbFilteredTransactionsManager(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManagerCaller{contract: contract}, nil
}

// NewArbFilteredTransactionsManagerTransactor creates a new write-only instance of ArbFilteredTransactionsManager, bound to a specific deployed contract.
func NewArbFilteredTransactionsManagerTransactor(address common.Address, transactor bind.ContractTransactor) (*ArbFilteredTransactionsManagerTransactor, error) {
	contract, err := bindArbFilteredTransactionsManager(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManagerTransactor{contract: contract}, nil
}

// NewArbFilteredTransactionsManagerFilterer creates a new log filterer instance of ArbFilteredTransactionsManager, bound to a specific deployed contract.
func NewArbFilteredTransactionsManagerFilterer(address common.Address, filterer bind.ContractFilterer) (*ArbFilteredTransactionsManagerFilterer, error) {
	contract, err := bindArbFilteredTransactionsManager(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManagerFilterer{contract: contract}, nil
}

// bindArbFilteredTransactionsManager binds a generic wrapper to an already deployed contract.
func bindArbFilteredTransactionsManager(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ArbFilteredTransactionsManagerMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	return bind.NewBoundContract(address, *parsed, caller, transactor, filterer), nil
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbFilteredTransactionsManager.Contract.ArbFilteredTransactionsManagerCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.ArbFilteredTransactionsManagerTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.ArbFilteredTransactionsManagerTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbFilteredTransactionsManager.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.contract.Transact(opts, method, params...)
}

// IsTransactionFiltered is a free data retrieval call binding the contract method 0x85c733a4.
//
// Solidity: function isTransactionFiltered(bytes32 txHash) view returns(bool)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerCaller) IsTransactionFiltered(opts *bind.CallOpts, txHash [32]byte) (bool, error) {
	var out []interface{}
	err := _ArbFilteredTransactionsManager.contract.Call(opts, &out, "isTransactionFiltered", txHash)
...
//
// Solidity: function isTransactionFiltered(bytes32 txHash) view returns(bool)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerSession) IsTransactionFiltered(txHash [32]byte) (bool, error) {
	return _ArbFilteredTransactionsManager.Contract.IsTransactionFiltered(&_ArbFilteredTransactionsManager.CallOpts, txHash)
}

// IsTransactionFiltered is a free data retrieval call binding the contract method 0x85c733a4.
//
// Solidity: function isTransactionFiltered(bytes32 txHash) view returns(bool)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerCallerSession) IsTransactionFiltered(txHash [32]byte) (bool, error) {
	return _ArbFilteredTransactionsManager.Contract.IsTransactionFiltered(&_ArbFilteredTransactionsManager.CallOpts, txHash)
}

// AddFilteredTransaction is a paid mutator transaction binding the contract method 0xcb470491.
//
// Solidity: function addFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactor) AddFilteredTransaction(opts *bind.TransactOpts, txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.contract.Transact(opts, "addFilteredTransaction", txHash)
}

// AddFilteredTransaction is a paid mutator transaction binding the contract method 0xcb470491.
//
// Solidity: function addFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerSession) AddFilteredTransaction(txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.AddFilteredTransaction(&_ArbFilteredTransactionsManager.TransactOpts, txHash)
}

// AddFilteredTransaction is a paid mutator transaction binding the contract method 0xcb470491.
//
// Solidity: function addFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactorSession) AddFilteredTransaction(txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.AddFilteredTransaction(&_ArbFilteredTransactionsManager.TransactOpts, txHash)
}

// DeleteFilteredTransaction is a paid mutator transaction binding the contract method 0xd26374b1.
//
// Solidity: function deleteFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactor) DeleteFilteredTransaction(opts *bind.TransactOpts, txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.contract.Transact(opts, "deleteFilteredTransaction", txHash)
}

// DeleteFilteredTransaction is a paid mutator transaction binding the contract method 0xd26374b1.
//
// Solidity: function deleteFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerSession) DeleteFilteredTransaction(txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.DeleteFilteredTransaction(&_ArbFilteredTransactionsManager.TransactOpts, txHash)
}

// DeleteFilteredTransaction is a paid mutator transaction binding the contract method 0xd26374b1.
//
// Solidity: function deleteFilteredTransaction(bytes32 txHash) returns()
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerTransactorSession) DeleteFilteredTransaction(txHash [32]byte) (*types.Transaction, error) {
	return _ArbFilteredTransactionsManager.Contract.DeleteFilteredTransaction(&_ArbFilteredTransactionsManager.TransactOpts, txHash)
}

// ArbFilteredTransactionsManagerFilteredTransactionAddedIterator is returned from FilterFilteredTransactionAdded and is used to iterate over the raw logs and unpacked data for FilteredTransactionAdded events raised by the ArbFilteredTransactionsManager contract.
type ArbFilteredTransactionsManagerFilteredTransactionAddedIterator struct {
	Event *ArbFilteredTransactionsManagerFilteredTransactionAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbFilteredTransactionsManagerFilteredTransactionAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbFilteredTransactionsManagerFilteredTransactionAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbFilteredTransactionsManagerFilteredTransactionAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbFilteredTransactionsManagerFilteredTransactionAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbFilteredTransactionsManagerFilteredTransactionAdded represents a FilteredTransactionAdded event raised by the ArbFilteredTransactionsManager contract.
type ArbFilteredTransactionsManagerFilteredTransactionAdded struct {
	TxHash [32]byte
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterFilteredTransactionAdded is a free log retrieval operation binding the contract event 0xde91070c821fde128c9ad6c14fac600aa5d701f4f74997eb997cd5591414426f.
//
// Solidity: event FilteredTransactionAdded(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) FilterFilteredTransactionAdded(opts *bind.FilterOpts, txHash [][32]byte) (*ArbFilteredTransactionsManagerFilteredTransactionAddedIterator, error) {
	...
	logs, sub, err := _ArbFilteredTransactionsManager.contract.FilterLogs(opts, "FilteredTransactionAdded", txHashRule)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManagerFilteredTransactionAddedIterator{contract: _ArbFilteredTransactionsManager.contract, event: "FilteredTransactionAdded", logs: logs, sub: sub}, nil
}

// WatchFilteredTransactionAdded is a free log subscription operation binding the contract event 0xde91070c821fde128c9ad6c14fac600aa5d701f4f74997eb997cd5591414426f.
//
// Solidity: event FilteredTransactionAdded(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) WatchFilteredTransactionAdded(opts *bind.WatchOpts, sink chan<- *ArbFilteredTransactionsManagerFilteredTransactionAdded, txHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _ArbFilteredTransactionsManager.contract.WatchLogs(opts, "FilteredTransactionAdded", txHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbFilteredTransactionsManagerFilteredTransactionAdded)
				if err := _ArbFilteredTransactionsManager.contract.UnpackLog(event, "FilteredTransactionAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFilteredTransactionAdded is a log parse operation binding the contract event 0xde91070c821fde128c9ad6c14fac600aa5d701f4f74997eb997cd5591414426f.
//
// Solidity: event FilteredTransactionAdded(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) ParseFilteredTransactionAdded(log types.Log) (*ArbFilteredTransactionsManagerFilteredTransactionAdded, error) {
	event := new(ArbFilteredTransactionsManagerFilteredTransactionAdded)
	if err := _ArbFilteredTransactionsManager.contract.UnpackLog(event, "FilteredTransactionAdded", log); err != nil {
		return nil, err
	}
...
// ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator is returned from FilterFilteredTransactionDeleted and is used to iterate over the raw logs and unpacked data for FilteredTransactionDeleted events raised by the ArbFilteredTransactionsManager contract.
type ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator struct {
	Event *ArbFilteredTransactionsManagerFilteredTransactionDeleted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbFilteredTransactionsManagerFilteredTransactionDeleted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbFilteredTransactionsManagerFilteredTransactionDeleted represents a FilteredTransactionDeleted event raised by the ArbFilteredTransactionsManager contract.
type ArbFilteredTransactionsManagerFilteredTransactionDeleted struct {
	TxHash [32]byte
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterFilteredTransactionDeleted is a free log retrieval operation binding the contract event 0xdb54a829e2a086557fb16aeb8950816c19960c430bf7d36c791c0f8382b66d22.
//
// Solidity: event FilteredTransactionDeleted(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) FilterFilteredTransactionDeleted(opts *bind.FilterOpts, txHash [][32]byte) (*ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator, error) {
	...
	logs, sub, err := _ArbFilteredTransactionsManager.contract.FilterLogs(opts, "FilteredTransactionDeleted", txHashRule)
	if err != nil {
		return nil, err
	}
	return &ArbFilteredTransactionsManagerFilteredTransactionDeletedIterator{contract: _ArbFilteredTransactionsManager.contract, event: "FilteredTransactionDeleted", logs: logs, sub: sub}, nil
}

// WatchFilteredTransactionDeleted is a free log subscription operation binding the contract event 0xdb54a829e2a086557fb16aeb8950816c19960c430bf7d36c791c0f8382b66d22.
//
// Solidity: event FilteredTransactionDeleted(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) WatchFilteredTransactionDeleted(opts *bind.WatchOpts, sink chan<- *ArbFilteredTransactionsManagerFilteredTransactionDeleted, txHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _ArbFilteredTransactionsManager.contract.WatchLogs(opts, "FilteredTransactionDeleted", txHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbFilteredTransactionsManagerFilteredTransactionDeleted)
				if err := _ArbFilteredTransactionsManager.contract.UnpackLog(event, "FilteredTransactionDeleted", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFilteredTransactionDeleted is a log parse operation binding the contract event 0xdb54a829e2a086557fb16aeb8950816c19960c430bf7d36c791c0f8382b66d22.
//
// Solidity: event FilteredTransactionDeleted(bytes32 indexed txHash)
func (_ArbFilteredTransactionsManager *ArbFilteredTransactionsManagerFilterer) ParseFilteredTransactionDeleted(log types.Log) (*ArbFilteredTransactionsManagerFilteredTransactionDeleted, error) {
	event := new(ArbFilteredTransactionsManagerFilteredTransactionDeleted)
	if err := _ArbFilteredTransactionsManager.contract.UnpackLog(event, "FilteredTransactionDeleted", log); err != nil {
		return nil, err
	}
...
// GetGasPricingConstraints is a free data retrieval call binding the contract method 0x232027d1.
//
// Solidity: function getGasPricingConstraints() view returns(uint64[3][] constraints)
func (_ArbGasInfo *ArbGasInfoCaller) GetGasPricingConstraints(opts *bind.CallOpts) ([][3]uint64, error) {
	var out []interface{}
	err := _ArbGasInfo.contract.Call(opts, &out, "getGasPricingConstraints")

	if err != nil {
		return *new([][3]uint64), err
	}

	out0 := *abi.ConvertType(out[0], new([][3]uint64)).(*[][3]uint64)
...
//
// Solidity: function getGasPricingConstraints() view returns(uint64[3][] constraints)
func (_ArbGasInfo *ArbGasInfoSession) GetGasPricingConstraints() ([][3]uint64, error) {
	return _ArbGasInfo.Contract.GetGasPricingConstraints(&_ArbGasInfo.CallOpts)
}

// GetGasPricingConstraints is a free data retrieval call binding the contract method 0x232027d1.
//
// Solidity: function getGasPricingConstraints() view returns(uint64[3][] constraints)
func (_ArbGasInfo *ArbGasInfoCallerSession) GetGasPricingConstraints() ([][3]uint64, error) {
	return _ArbGasInfo.Contract.GetGasPricingConstraints(&_ArbGasInfo.CallOpts)
}
...
// GetMaxBlockGasLimit is a free data retrieval call binding the contract method 0x0371fdb4.
//
// Solidity: function getMaxBlockGasLimit() view returns(uint64)
func (_ArbGasInfo *ArbGasInfoCaller) GetMaxBlockGasLimit(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ArbGasInfo.contract.Call(opts, &out, "getMaxBlockGasLimit")
...
//
// Solidity: function getMaxBlockGasLimit() view returns(uint64)
func (_ArbGasInfo *ArbGasInfoSession) GetMaxBlockGasLimit() (uint64, error) {
	return _ArbGasInfo.Contract.GetMaxBlockGasLimit(&_ArbGasInfo.CallOpts)
}

// GetMaxBlockGasLimit is a free data retrieval call binding the contract method 0x0371fdb4.
//
// Solidity: function getMaxBlockGasLimit() view returns(uint64)
func (_ArbGasInfo *ArbGasInfoCallerSession) GetMaxBlockGasLimit() (uint64, error) {
	return _ArbGasInfo.Contract.GetMaxBlockGasLimit(&_ArbGasInfo.CallOpts)
}

// GetMaxTxGasLimit is a free data retrieval call binding the contract method 0xaae1cd4c.
//
// Solidity: function getMaxTxGasLimit() view returns(uint256)
func (_ArbGasInfo *ArbGasInfoCaller) GetMaxTxGasLimit(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ArbGasInfo.contract.Call(opts, &out, "getMaxTxGasLimit")
...
//
// Solidity: function getMaxTxGasLimit() view returns(uint256)
func (_ArbGasInfo *ArbGasInfoSession) GetMaxTxGasLimit() (*big.Int, error) {
	return _ArbGasInfo.Contract.GetMaxTxGasLimit(&_ArbGasInfo.CallOpts)
}

// GetMaxTxGasLimit is a free data retrieval call binding the contract method 0xaae1cd4c.
//
// Solidity: function getMaxTxGasLimit() view returns(uint256)
func (_ArbGasInfo *ArbGasInfoCallerSession) GetMaxTxGasLimit() (*big.Int, error) {
	return _ArbGasInfo.Contract.GetMaxTxGasLimit(&_ArbGasInfo.CallOpts)
}
...
// GetMultiGasBaseFee is a free data retrieval call binding the contract method 0xc0e10bbb.
//
// Solidity: function getMultiGasBaseFee() view returns(uint256[] baseFees)
func (_ArbGasInfo *ArbGasInfoCaller) GetMultiGasBaseFee(opts *bind.CallOpts) ([]*big.Int, error) {
	var out []interface{}
	err := _ArbGasInfo.contract.Call(opts, &out, "getMultiGasBaseFee")
...
//
// Solidity: function getMultiGasBaseFee() view returns(uint256[] baseFees)
func (_ArbGasInfo *ArbGasInfoSession) GetMultiGasBaseFee() ([]*big.Int, error) {
	return _ArbGasInfo.Contract.GetMultiGasBaseFee(&_ArbGasInfo.CallOpts)
}

// GetMultiGasBaseFee is a free data retrieval call binding the contract method 0xc0e10bbb.
//
// Solidity: function getMultiGasBaseFee() view returns(uint256[] baseFees)
func (_ArbGasInfo *ArbGasInfoCallerSession) GetMultiGasBaseFee() ([]*big.Int, error) {
	return _ArbGasInfo.Contract.GetMultiGasBaseFee(&_ArbGasInfo.CallOpts)
}

// GetMultiGasPricingConstraints is a free data retrieval call binding the contract method 0xbbfc0a72.
//
// Solidity: function getMultiGasPricingConstraints() view returns(((uint8,uint64)[],uint32,uint64,uint64)[] constraints)
func (_ArbGasInfo *ArbGasInfoCaller) GetMultiGasPricingConstraints(opts *bind.CallOpts) ([]ArbMultiGasConstraintsTypesResourceConstraint, error) {
	var out []interface{}
	err := _ArbGasInfo.contract.Call(opts, &out, "getMultiGasPricingConstraints")

	if err != nil {
		return *new([]ArbMultiGasConstraintsTypesResourceConstraint), err
	}

	out0 := *abi.ConvertType(out[0], new([]ArbMultiGasConstraintsTypesResourceConstraint)).(*[]ArbMultiGasConstraintsTypesResourceConstraint)
...
//
// Solidity: function getMultiGasPricingConstraints() view returns(((uint8,uint64)[],uint32,uint64,uint64)[] constraints)
func (_ArbGasInfo *ArbGasInfoSession) GetMultiGasPricingConstraints() ([]ArbMultiGasConstraintsTypesResourceConstraint, error) {
	return _ArbGasInfo.Contract.GetMultiGasPricingConstraints(&_ArbGasInfo.CallOpts)
}

// GetMultiGasPricingConstraints is a free data retrieval call binding the contract method 0xbbfc0a72.
//
// Solidity: function getMultiGasPricingConstraints() view returns(((uint8,uint64)[],uint32,uint64,uint64)[] constraints)
func (_ArbGasInfo *ArbGasInfoCallerSession) GetMultiGasPricingConstraints() ([]ArbMultiGasConstraintsTypesResourceConstraint, error) {
	return _ArbGasInfo.Contract.GetMultiGasPricingConstraints(&_ArbGasInfo.CallOpts)
}
...
// ArbMultiGasConstraintsTypesMetaData contains all meta data concerning the ArbMultiGasConstraintsTypes contract.
var ArbMultiGasConstraintsTypesMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}

// ArbMultiGasConstraintsTypesABI is the input ABI used to generate the binding from.
// Deprecated: Use ArbMultiGasConstraintsTypesMetaData.ABI instead.
var ArbMultiGasConstraintsTypesABI = ArbMultiGasConstraintsTypesMetaData.ABI

// ArbMultiGasConstraintsTypesBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use ArbMultiGasConstraintsTypesMetaData.Bin instead.
var ArbMultiGasConstraintsTypesBin = ArbMultiGasConstraintsTypesMetaData.Bin

// DeployArbMultiGasConstraintsTypes deploys a new Ethereum contract, binding an instance of ArbMultiGasConstraintsTypes to it.
func DeployArbMultiGasConstraintsTypes(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *ArbMultiGasConstraintsTypes, error) {
	parsed, err := ArbMultiGasConstraintsTypesMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ArbMultiGasConstraintsTypesBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &ArbMultiGasConstraintsTypes{ArbMultiGasConstraintsTypesCaller: ArbMultiGasConstraintsTypesCaller{contract: contract}, ArbMultiGasConstraintsTypesTransactor: ArbMultiGasConstraintsTypesTransactor{contract: contract}, ArbMultiGasConstraintsTypesFilterer: ArbMultiGasConstraintsTypesFilterer{contract: contract}}, nil
}

// ArbMultiGasConstraintsTypes is an auto generated Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypes struct {
	ArbMultiGasConstraintsTypesCaller     // Read-only binding to the contract
	ArbMultiGasConstraintsTypesTransactor // Write-only binding to the contract
	ArbMultiGasConstraintsTypesFilterer   // Log filterer for contract events
}

// ArbMultiGasConstraintsTypesCaller is an auto generated read-only Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypesCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbMultiGasConstraintsTypesTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypesTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbMultiGasConstraintsTypesFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ArbMultiGasConstraintsTypesFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbMultiGasConstraintsTypesSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ArbMultiGasConstraintsTypesSession struct {
	Contract     *ArbMultiGasConstraintsTypes // Generic contract binding to set the session for
	CallOpts     bind.CallOpts                // Call options to use throughout this session
	TransactOpts bind.TransactOpts            // Transaction auth options to use throughout this session
}

// ArbMultiGasConstraintsTypesCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ArbMultiGasConstraintsTypesCallerSession struct {
	Contract *ArbMultiGasConstraintsTypesCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                      // Call options to use throughout this session
}

// ArbMultiGasConstraintsTypesTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ArbMultiGasConstraintsTypesTransactorSession struct {
	Contract     *ArbMultiGasConstraintsTypesTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                      // Transaction auth options to use throughout this session
}

// ArbMultiGasConstraintsTypesRaw is an auto generated low-level Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypesRaw struct {
	Contract *ArbMultiGasConstraintsTypes // Generic contract binding to access the raw methods on
}

// ArbMultiGasConstraintsTypesCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypesCallerRaw struct {
	Contract *ArbMultiGasConstraintsTypesCaller // Generic read-only contract binding to access the raw methods on
}

// ArbMultiGasConstraintsTypesTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ArbMultiGasConstraintsTypesTransactorRaw struct {
	Contract *ArbMultiGasConstraintsTypesTransactor // Generic write-only contract binding to access the raw methods on
}

// NewArbMultiGasConstraintsTypes creates a new instance of ArbMultiGasConstraintsTypes, bound to a specific deployed contract.
func NewArbMultiGasConstraintsTypes(address common.Address, backend bind.ContractBackend) (*ArbMultiGasConstraintsTypes, error) {
	contract, err := bindArbMultiGasConstraintsTypes(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ArbMultiGasConstraintsTypes{ArbMultiGasConstraintsTypesCaller: ArbMultiGasConstraintsTypesCaller{contract: contract}, ArbMultiGasConstraintsTypesTransactor: ArbMultiGasConstraintsTypesTransactor{contract: contract}, ArbMultiGasConstraintsTypesFilterer: ArbMultiGasConstraintsTypesFilterer{contract: contract}}, nil
}

// NewArbMultiGasConstraintsTypesCaller creates a new read-only instance of ArbMultiGasConstraintsTypes, bound to a specific deployed contract.
func NewArbMultiGasConstraintsTypesCaller(address common.Address, caller bind.ContractCaller) (*ArbMultiGasConstraintsTypesCaller, error) {
	contract, err := bindArbMultiGasConstraintsTypes(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ArbMultiGasConstraintsTypesCaller{contract: contract}, nil
}

// NewArbMultiGasConstraintsTypesTransactor creates a new write-only instance of ArbMultiGasConstraintsTypes, bound to a specific deployed contract.
func NewArbMultiGasConstraintsTypesTransactor(address common.Address, transactor bind.ContractTransactor) (*ArbMultiGasConstraintsTypesTransactor, error) {
	contract, err := bindArbMultiGasConstraintsTypes(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ArbMultiGasConstraintsTypesTransactor{contract: contract}, nil
}

// NewArbMultiGasConstraintsTypesFilterer creates a new log filterer instance of ArbMultiGasConstraintsTypes, bound to a specific deployed contract.
func NewArbMultiGasConstraintsTypesFilterer(address common.Address, filterer bind.ContractFilterer) (*ArbMultiGasConstraintsTypesFilterer, error) {
	contract, err := bindArbMultiGasConstraintsTypes(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ArbMultiGasConstraintsTypesFilterer{contract: contract}, nil
}

// bindArbMultiGasConstraintsTypes binds a generic wrapper to an already deployed contract.
func bindArbMultiGasConstraintsTypes(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ArbMultiGasConstraintsTypesMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbMultiGasConstraintsTypes.Contract.ArbMultiGasConstraintsTypesCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbMultiGasConstraintsTypes.Contract.ArbMultiGasConstraintsTypesTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbMultiGasConstraintsTypes.Contract.ArbMultiGasConstraintsTypesTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbMultiGasConstraintsTypes.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbMultiGasConstraintsTypes.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbMultiGasConstraintsTypes *ArbMultiGasConstraintsTypesTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbMultiGasConstraintsTypes.Contract.contract.Transact(opts, method, params...)
}
...
var ArbOwnerMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"addChainOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"addNativeTokenOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"addTransactionFilterer\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"manager\",\"type\":\"address\"}],\"name\":\"addWasmCacheManager\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllChainOwners\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllNativeTokenOwners\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllTransactionFilterers\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getFilteredFundsRecipient\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getInfraFeeAccount\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getNetworkFeeAccount\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"isChainOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"isNativeTokenOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"isTransactionFilterer\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"maxWeiToRelease\",\"type\":\"uint256\"}],\"name\":\"releaseL1PricerSurplusFunds\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"ownerToRemove\",\"type\":\"address\"}],\"name\":\"removeChainOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"ownerToRemove\",\"type\":\"address\"}],\"name\":\"removeNativeTokenOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"removeTransactionFilterer\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"manager\",\"type\":\"address\"}],\"name\":\"removeWasmCacheManager\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"newVersion\",\"type\":\"uint64\"},{\"internalType\":\"uint64\",\"name\":\"timestamp\",\"type\":\"uint64\"}],\"name\":\"scheduleArbOSUpgrade\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"cap\",\"type\":\"uint64\"}],\"name\":\"setAmortizedCostCapBips\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"level\",\"type\":\"uint64\"}],\"name\":\"setBrotliCompressionLevel\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bool\",\"name\":\"enable\",\"type\":\"bool\"}],\"name\":\"setCalldataPriceIncrease\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"chainConfig\",\"type\":\"string\"}],\"name\":\"setChainConfig\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bool\",\"name\":\"collectTips\",\"type\":\"bool\"}],\"name\":\"setCollectTips\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newRecipient\",\"type\":\"address\"}],\"name\":\"setFilteredFundsRecipient\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"backlog\",\"type\":\"uint64\"}],\"name\":\"setGasBacklog\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64[3][]\",\"name\":\"constraints\",\"type\":\"uint64[3][]\"}],\"name\":\"setGasPricingConstraints\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newInfraFeeAccount\",\"type\":\"address\"}],\"name\":\"setInfraFeeAccount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint32\",\"name\":\"price\",\"type\":\"uint32\"}],\"name\":\"setInkPrice\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"inertia\",\"type\":\"uint64\"}],\"name\":\"setL1BaseFeeEstimateInertia\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"pricePerUnit\",\"type\":\"uint256\"}],\"name\":\"setL1PricePerUnit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"equilibrationUnits\",\"type\":\"uint256\"}],\"name\":\"setL1PricingEquilibrationUnits\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"inertia\",\"type\":\"uint64\"}],\"name\":\"setL1PricingInertia\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"weiPerUnit\",\"type\":\"uint64\"}],\"name\":\"setL1PricingRewardRate\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"recipient\",\"type\":\"address\"}],\"name\":\"setL1PricingRewardRecipient\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"priceInWei\",\"type\":\"uint256\"}],\"name\":\"setL2BaseFee\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"sec\",\"type\":\"uint64\"}],\"name\":\"setL2GasBacklogTolerance\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"sec\",\"type\":\"uint64\"}],\"name\":\"setL2GasPricingInertia\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"limit\",\"type\":\"uint64\"}],\"name\":\"setMaxBlockGasLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint8\",\"name\":\"maxFragments\",\"type\":\"uint8\"}],\"name\":\"setMaxStylusContractFragments\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"limit\",\"type\":\"uint64\"}],\"name\":\"setMaxTxGasLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"priceInWei\",\"type\":\"uint256\"}],\"name\":\"setMinimumL2BaseFee\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"components\":[{\"components\":[{\"internalType\":\"enumArbMultiGasConstraintsTypes.ResourceKind\",\"name\":\"resource\",\"type\":\"uint8\"},{\"internalType\":\"uint64\",\"name\":\"weight\",\"type\":\"uint64\"}],\"internalType\":\"structArbMultiGasConstraintsTypes.WeightedResource[]\",\"name\":\"resources\",\"type\":\"tuple[]\"},{\"internalType\":\"uint32\",\"name\":\"adjustmentWindowSecs\",\"type\":\"uint32\"},{\"internalType\":\"uint64\",\"name\":\"targetPerSec\",\"type\":\"uint64\"},{\"internalType\":\"uint64\",\"name\":\"backlog\",\"type\":\"uint64\"}],\"internalType\":\"structArbMultiGasConstraintsTypes.ResourceConstraint[]\",\"name\":\"constraints\",\"type\":\"tuple[]\"}],\"name\":\"setMultiGasPricingConstraints\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"timestamp\",\"type\":\"uint64\"}],\"name\":\"setNativeTokenManagementFrom\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newNetworkFeeAccount\",\"type\":\"address\"}],\"name\":\"setNetworkFeeAccount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"floorPerToken\",\"type\":\"uint64\"}],\"name\":\"setParentGasFloorPerToken\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"int64\",\"name\":\"cost\",\"type\":\"int64\"}],\"name\":\"setPerBatchGasCharge\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"limit\",\"type\":\"uint64\"}],\"name\":\"setSpeedLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"timestamp\",\"type\":\"uint64\"}],\"name\":\"setTransactionFilteringFrom\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"gas\",\"type\":\"uint64\"}],\"name\":\"setWasmActivationGas\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"count\",\"type\":\"uint16\"}],\"name\":\"setWasmBlockCacheSize\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"_days\",\"type\":\"uint16\"}],\"name\":\"setWasmExpiryDays\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"pages\",\"type\":\"uint16\"}],\"name\":\"setWasmFreePages\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint64\",\"name\":\"percent\",\"type\":\"uint64\"}],\"name\":\"setWasmInitCostScalar\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"_days\",\"type\":\"uint16\"}],\"name\":\"setWasmKeepaliveDays\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint32\",\"name\":\"size\",\"type\":\"uint32\"}],\"name\":\"setWasmMaxSize\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint32\",\"name\":\"depth\",\"type\":\"uint32\"}],\"name\":\"setWasmMaxStackDepth\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint8\",\"name\":\"gas\",\"type\":\"uint8\"},{\"internalType\":\"uint16\",\"name\":\"cached\",\"type\":\"uint16\"}],\"name\":\"setWasmMinInitGas\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"gas\",\"type\":\"uint16\"}],\"name\":\"setWasmPageGas\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint16\",\"name\":\"limit\",\"type\":\"uint16\"}],\"name\":\"setWasmPageLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"ChainOwnerAdded\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"ChainOwnerRemoved\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newRecipient\",\"type\":\"address\"}],\"name\":\"FilteredFundsRecipientSet\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"NativeTokenOwnerAdded\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"NativeTokenOwnerRemoved\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes4\",\"name\":\"method\",\"type\":\"bytes4\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"}],\"name\":\"OwnerActs\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"TransactionFiltererAdded\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"TransactionFiltererRemoved\",\"type\":\"event\"}]",
}
...
// GetAllTransactionFilterers is a free data retrieval call binding the contract method 0x595fbb5a.
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwner *ArbOwnerCaller) GetAllTransactionFilterers(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _ArbOwner.contract.Call(opts, &out, "getAllTransactionFilterers")
...
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwner *ArbOwnerSession) GetAllTransactionFilterers() ([]common.Address, error) {
	return _ArbOwner.Contract.GetAllTransactionFilterers(&_ArbOwner.CallOpts)
}

// GetAllTransactionFilterers is a free data retrieval call binding the contract method 0x595fbb5a.
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwner *ArbOwnerCallerSession) GetAllTransactionFilterers() ([]common.Address, error) {
	return _ArbOwner.Contract.GetAllTransactionFilterers(&_ArbOwner.CallOpts)
}

// GetFilteredFundsRecipient is a free data retrieval call binding the contract method 0x3caa5f12.
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwner *ArbOwnerCaller) GetFilteredFundsRecipient(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbOwner.contract.Call(opts, &out, "getFilteredFundsRecipient")
...
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwner *ArbOwnerSession) GetFilteredFundsRecipient() (common.Address, error) {
	return _ArbOwner.Contract.GetFilteredFundsRecipient(&_ArbOwner.CallOpts)
}

// GetFilteredFundsRecipient is a free data retrieval call binding the contract method 0x3caa5f12.
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwner *ArbOwnerCallerSession) GetFilteredFundsRecipient() (common.Address, error) {
	return _ArbOwner.Contract.GetFilteredFundsRecipient(&_ArbOwner.CallOpts)
}
...
// IsTransactionFilterer is a free data retrieval call binding the contract method 0xb32352c3.
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwner *ArbOwnerCaller) IsTransactionFilterer(opts *bind.CallOpts, filterer common.Address) (bool, error) {
	var out []interface{}
	err := _ArbOwner.contract.Call(opts, &out, "isTransactionFilterer", filterer)
...
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwner *ArbOwnerSession) IsTransactionFilterer(filterer common.Address) (bool, error) {
	return _ArbOwner.Contract.IsTransactionFilterer(&_ArbOwner.CallOpts, filterer)
}

// IsTransactionFilterer is a free data retrieval call binding the contract method 0xb32352c3.
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwner *ArbOwnerCallerSession) IsTransactionFilterer(filterer common.Address) (bool, error) {
	return _ArbOwner.Contract.IsTransactionFilterer(&_ArbOwner.CallOpts, filterer)
}
...
// AddTransactionFilterer is a paid mutator transaction binding the contract method 0x59c87acc.
//
// Solidity: function addTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerTransactor) AddTransactionFilterer(opts *bind.TransactOpts, filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "addTransactionFilterer", filterer)
}

// AddTransactionFilterer is a paid mutator transaction binding the contract method 0x59c87acc.
//
// Solidity: function addTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerSession) AddTransactionFilterer(filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.AddTransactionFilterer(&_ArbOwner.TransactOpts, filterer)
}

// AddTransactionFilterer is a paid mutator transaction binding the contract method 0x59c87acc.
//
// Solidity: function addTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerTransactorSession) AddTransactionFilterer(filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.AddTransactionFilterer(&_ArbOwner.TransactOpts, filterer)
}
...
// RemoveTransactionFilterer is a paid mutator transaction binding the contract method 0x67ada089.
//
// Solidity: function removeTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerTransactor) RemoveTransactionFilterer(opts *bind.TransactOpts, filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "removeTransactionFilterer", filterer)
}

// RemoveTransactionFilterer is a paid mutator transaction binding the contract method 0x67ada089.
//
// Solidity: function removeTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerSession) RemoveTransactionFilterer(filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.RemoveTransactionFilterer(&_ArbOwner.TransactOpts, filterer)
}

// RemoveTransactionFilterer is a paid mutator transaction binding the contract method 0x67ada089.
//
// Solidity: function removeTransactionFilterer(address filterer) returns()
func (_ArbOwner *ArbOwnerTransactorSession) RemoveTransactionFilterer(filterer common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.RemoveTransactionFilterer(&_ArbOwner.TransactOpts, filterer)
}
...
// SetCollectTips is a paid mutator transaction binding the contract method 0xa858dbe2.
//
// Solidity: function setCollectTips(bool collectTips) returns()
func (_ArbOwner *ArbOwnerTransactor) SetCollectTips(opts *bind.TransactOpts, collectTips bool) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setCollectTips", collectTips)
}

// SetCollectTips is a paid mutator transaction binding the contract method 0xa858dbe2.
//
// Solidity: function setCollectTips(bool collectTips) returns()
func (_ArbOwner *ArbOwnerSession) SetCollectTips(collectTips bool) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetCollectTips(&_ArbOwner.TransactOpts, collectTips)
}

// SetCollectTips is a paid mutator transaction binding the contract method 0xa858dbe2.
//
// Solidity: function setCollectTips(bool collectTips) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetCollectTips(collectTips bool) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetCollectTips(&_ArbOwner.TransactOpts, collectTips)
}

// SetFilteredFundsRecipient is a paid mutator transaction binding the contract method 0xb79da0e9.
//
// Solidity: function setFilteredFundsRecipient(address newRecipient) returns()
func (_ArbOwner *ArbOwnerTransactor) SetFilteredFundsRecipient(opts *bind.TransactOpts, newRecipient common.Address) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setFilteredFundsRecipient", newRecipient)
}

// SetFilteredFundsRecipient is a paid mutator transaction binding the contract method 0xb79da0e9.
//
// Solidity: function setFilteredFundsRecipient(address newRecipient) returns()
func (_ArbOwner *ArbOwnerSession) SetFilteredFundsRecipient(newRecipient common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetFilteredFundsRecipient(&_ArbOwner.TransactOpts, newRecipient)
}

// SetFilteredFundsRecipient is a paid mutator transaction binding the contract method 0xb79da0e9.
//
// Solidity: function setFilteredFundsRecipient(address newRecipient) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetFilteredFundsRecipient(newRecipient common.Address) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetFilteredFundsRecipient(&_ArbOwner.TransactOpts, newRecipient)
}

// SetGasBacklog is a paid mutator transaction binding the contract method 0x68fc808a.
//
// Solidity: function setGasBacklog(uint64 backlog) returns()
func (_ArbOwner *ArbOwnerTransactor) SetGasBacklog(opts *bind.TransactOpts, backlog uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setGasBacklog", backlog)
}

// SetGasBacklog is a paid mutator transaction binding the contract method 0x68fc808a.
//
// Solidity: function setGasBacklog(uint64 backlog) returns()
func (_ArbOwner *ArbOwnerSession) SetGasBacklog(backlog uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetGasBacklog(&_ArbOwner.TransactOpts, backlog)
}

// SetGasBacklog is a paid mutator transaction binding the contract method 0x68fc808a.
//
// Solidity: function setGasBacklog(uint64 backlog) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetGasBacklog(backlog uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetGasBacklog(&_ArbOwner.TransactOpts, backlog)
}
...
func (_ArbOwner *ArbOwnerTransactor) SetGasPricingConstraints(opts *bind.TransactOpts, constraints [][3]uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setGasPricingConstraints", constraints)
}

// SetGasPricingConstraints is a paid mutator transaction binding the contract method 0xcc0d556a.
//
// Solidity: function setGasPricingConstraints(uint64[3][] constraints) returns()
func (_ArbOwner *ArbOwnerSession) SetGasPricingConstraints(constraints [][3]uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetGasPricingConstraints(&_ArbOwner.TransactOpts, constraints)
}

// SetGasPricingConstraints is a paid mutator transaction binding the contract method 0xcc0d556a.
//
// Solidity: function setGasPricingConstraints(uint64[3][] constraints) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetGasPricingConstraints(constraints [][3]uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetGasPricingConstraints(&_ArbOwner.TransactOpts, constraints)
}
...
// SetMaxBlockGasLimit is a paid mutator transaction binding the contract method 0xae105c80.
//
// Solidity: function setMaxBlockGasLimit(uint64 limit) returns()
func (_ArbOwner *ArbOwnerTransactor) SetMaxBlockGasLimit(opts *bind.TransactOpts, limit uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setMaxBlockGasLimit", limit)
}

// SetMaxBlockGasLimit is a paid mutator transaction binding the contract method 0xae105c80.
//
// Solidity: function setMaxBlockGasLimit(uint64 limit) returns()
func (_ArbOwner *ArbOwnerSession) SetMaxBlockGasLimit(limit uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMaxBlockGasLimit(&_ArbOwner.TransactOpts, limit)
}

// SetMaxBlockGasLimit is a paid mutator transaction binding the contract method 0xae105c80.
//
// Solidity: function setMaxBlockGasLimit(uint64 limit) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetMaxBlockGasLimit(limit uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMaxBlockGasLimit(&_ArbOwner.TransactOpts, limit)
}

// SetMaxStylusContractFragments is a paid mutator transaction binding the contract method 0xf1fe1a70.
//
// Solidity: function setMaxStylusContractFragments(uint8 maxFragments) returns()
func (_ArbOwner *ArbOwnerTransactor) SetMaxStylusContractFragments(opts *bind.TransactOpts, maxFragments uint8) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setMaxStylusContractFragments", maxFragments)
}

// SetMaxStylusContractFragments is a paid mutator transaction binding the contract method 0xf1fe1a70.
//
// Solidity: function setMaxStylusContractFragments(uint8 maxFragments) returns()
func (_ArbOwner *ArbOwnerSession) SetMaxStylusContractFragments(maxFragments uint8) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMaxStylusContractFragments(&_ArbOwner.TransactOpts, maxFragments)
}

// SetMaxStylusContractFragments is a paid mutator transaction binding the contract method 0xf1fe1a70.
//
// Solidity: function setMaxStylusContractFragments(uint8 maxFragments) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetMaxStylusContractFragments(maxFragments uint8) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMaxStylusContractFragments(&_ArbOwner.TransactOpts, maxFragments)
}
...
// SetMultiGasPricingConstraints is a paid mutator transaction binding the contract method 0x2b05bb39.
//
// Solidity: function setMultiGasPricingConstraints(((uint8,uint64)[],uint32,uint64,uint64)[] constraints) returns()
func (_ArbOwner *ArbOwnerTransactor) SetMultiGasPricingConstraints(opts *bind.TransactOpts, constraints []ArbMultiGasConstraintsTypesResourceConstraint) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setMultiGasPricingConstraints", constraints)
}

// SetMultiGasPricingConstraints is a paid mutator transaction binding the contract method 0x2b05bb39.
//
// Solidity: function setMultiGasPricingConstraints(((uint8,uint64)[],uint32,uint64,uint64)[] constraints) returns()
func (_ArbOwner *ArbOwnerSession) SetMultiGasPricingConstraints(constraints []ArbMultiGasConstraintsTypesResourceConstraint) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMultiGasPricingConstraints(&_ArbOwner.TransactOpts, constraints)
}

// SetMultiGasPricingConstraints is a paid mutator transaction binding the contract method 0x2b05bb39.
//
// Solidity: function setMultiGasPricingConstraints(((uint8,uint64)[],uint32,uint64,uint64)[] constraints) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetMultiGasPricingConstraints(constraints []ArbMultiGasConstraintsTypesResourceConstraint) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetMultiGasPricingConstraints(&_ArbOwner.TransactOpts, constraints)
}
...
// SetParentGasFloorPerToken is a paid mutator transaction binding the contract method 0x3a930b0b.
//
// Solidity: function setParentGasFloorPerToken(uint64 floorPerToken) returns()
func (_ArbOwner *ArbOwnerTransactor) SetParentGasFloorPerToken(opts *bind.TransactOpts, floorPerToken uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setParentGasFloorPerToken", floorPerToken)
}

// SetParentGasFloorPerToken is a paid mutator transaction binding the contract method 0x3a930b0b.
//
// Solidity: function setParentGasFloorPerToken(uint64 floorPerToken) returns()
func (_ArbOwner *ArbOwnerSession) SetParentGasFloorPerToken(floorPerToken uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetParentGasFloorPerToken(&_ArbOwner.TransactOpts, floorPerToken)
}

// SetParentGasFloorPerToken is a paid mutator transaction binding the contract method 0x3a930b0b.
//
// Solidity: function setParentGasFloorPerToken(uint64 floorPerToken) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetParentGasFloorPerToken(floorPerToken uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetParentGasFloorPerToken(&_ArbOwner.TransactOpts, floorPerToken)
}
...
// SetTransactionFilteringFrom is a paid mutator transaction binding the contract method 0x46066e45.
//
// Solidity: function setTransactionFilteringFrom(uint64 timestamp) returns()
func (_ArbOwner *ArbOwnerTransactor) SetTransactionFilteringFrom(opts *bind.TransactOpts, timestamp uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setTransactionFilteringFrom", timestamp)
}

// SetTransactionFilteringFrom is a paid mutator transaction binding the contract method 0x46066e45.
//
// Solidity: function setTransactionFilteringFrom(uint64 timestamp) returns()
func (_ArbOwner *ArbOwnerSession) SetTransactionFilteringFrom(timestamp uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetTransactionFilteringFrom(&_ArbOwner.TransactOpts, timestamp)
}

// SetTransactionFilteringFrom is a paid mutator transaction binding the contract method 0x46066e45.
//
// Solidity: function setTransactionFilteringFrom(uint64 timestamp) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetTransactionFilteringFrom(timestamp uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetTransactionFilteringFrom(&_ArbOwner.TransactOpts, timestamp)
}

// SetWasmActivationGas is a paid mutator transaction binding the contract method 0xa0a32497.
//
// Solidity: function setWasmActivationGas(uint64 gas) returns()
func (_ArbOwner *ArbOwnerTransactor) SetWasmActivationGas(opts *bind.TransactOpts, gas uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setWasmActivationGas", gas)
}

// SetWasmActivationGas is a paid mutator transaction binding the contract method 0xa0a32497.
//
// Solidity: function setWasmActivationGas(uint64 gas) returns()
func (_ArbOwner *ArbOwnerSession) SetWasmActivationGas(gas uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmActivationGas(&_ArbOwner.TransactOpts, gas)
}

// SetWasmActivationGas is a paid mutator transaction binding the contract method 0xa0a32497.
//
// Solidity: function setWasmActivationGas(uint64 gas) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetWasmActivationGas(gas uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmActivationGas(&_ArbOwner.TransactOpts, gas)
}
...
// ArbOwnerChainOwnerAddedIterator is returned from FilterChainOwnerAdded and is used to iterate over the raw logs and unpacked data for ChainOwnerAdded events raised by the ArbOwner contract.
type ArbOwnerChainOwnerAddedIterator struct {
	Event *ArbOwnerChainOwnerAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerChainOwnerAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerChainOwnerAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerChainOwnerAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerChainOwnerAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerChainOwnerAdded represents a ChainOwnerAdded event raised by the ArbOwner contract.
type ArbOwnerChainOwnerAdded struct {
	Owner common.Address
	Raw   types.Log // Blockchain specific contextual infos
}

// FilterChainOwnerAdded is a free log retrieval operation binding the contract event 0x468eb89423e509e6b3edfd60f81c5d0f2ad5362307bd4db79a183c8a8f6bf430.
//
// Solidity: event ChainOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) FilterChainOwnerAdded(opts *bind.FilterOpts, owner []common.Address) (*ArbOwnerChainOwnerAddedIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "ChainOwnerAdded", ownerRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerChainOwnerAddedIterator{contract: _ArbOwner.contract, event: "ChainOwnerAdded", logs: logs, sub: sub}, nil
}

// WatchChainOwnerAdded is a free log subscription operation binding the contract event 0x468eb89423e509e6b3edfd60f81c5d0f2ad5362307bd4db79a183c8a8f6bf430.
//
// Solidity: event ChainOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) WatchChainOwnerAdded(opts *bind.WatchOpts, sink chan<- *ArbOwnerChainOwnerAdded, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "ChainOwnerAdded", ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerChainOwnerAdded)
				if err := _ArbOwner.contract.UnpackLog(event, "ChainOwnerAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseChainOwnerAdded is a log parse operation binding the contract event 0x468eb89423e509e6b3edfd60f81c5d0f2ad5362307bd4db79a183c8a8f6bf430.
//
// Solidity: event ChainOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) ParseChainOwnerAdded(log types.Log) (*ArbOwnerChainOwnerAdded, error) {
	event := new(ArbOwnerChainOwnerAdded)
	if err := _ArbOwner.contract.UnpackLog(event, "ChainOwnerAdded", log); err != nil {
		return nil, err
	}
...
// ArbOwnerChainOwnerRemovedIterator is returned from FilterChainOwnerRemoved and is used to iterate over the raw logs and unpacked data for ChainOwnerRemoved events raised by the ArbOwner contract.
type ArbOwnerChainOwnerRemovedIterator struct {
	Event *ArbOwnerChainOwnerRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerChainOwnerRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerChainOwnerRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerChainOwnerRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerChainOwnerRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerChainOwnerRemoved represents a ChainOwnerRemoved event raised by the ArbOwner contract.
type ArbOwnerChainOwnerRemoved struct {
	Owner common.Address
	Raw   types.Log // Blockchain specific contextual infos
}

// FilterChainOwnerRemoved is a free log retrieval operation binding the contract event 0xadccaaabc4a1e1609c82e07cd301c9563c2ed46559becda0e14373ab9d480f15.
//
// Solidity: event ChainOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) FilterChainOwnerRemoved(opts *bind.FilterOpts, owner []common.Address) (*ArbOwnerChainOwnerRemovedIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "ChainOwnerRemoved", ownerRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerChainOwnerRemovedIterator{contract: _ArbOwner.contract, event: "ChainOwnerRemoved", logs: logs, sub: sub}, nil
}

// WatchChainOwnerRemoved is a free log subscription operation binding the contract event 0xadccaaabc4a1e1609c82e07cd301c9563c2ed46559becda0e14373ab9d480f15.
//
// Solidity: event ChainOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) WatchChainOwnerRemoved(opts *bind.WatchOpts, sink chan<- *ArbOwnerChainOwnerRemoved, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "ChainOwnerRemoved", ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerChainOwnerRemoved)
				if err := _ArbOwner.contract.UnpackLog(event, "ChainOwnerRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseChainOwnerRemoved is a log parse operation binding the contract event 0xadccaaabc4a1e1609c82e07cd301c9563c2ed46559becda0e14373ab9d480f15.
//
// Solidity: event ChainOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) ParseChainOwnerRemoved(log types.Log) (*ArbOwnerChainOwnerRemoved, error) {
	event := new(ArbOwnerChainOwnerRemoved)
	if err := _ArbOwner.contract.UnpackLog(event, "ChainOwnerRemoved", log); err != nil {
		return nil, err
	}
...
// ArbOwnerFilteredFundsRecipientSetIterator is returned from FilterFilteredFundsRecipientSet and is used to iterate over the raw logs and unpacked data for FilteredFundsRecipientSet events raised by the ArbOwner contract.
type ArbOwnerFilteredFundsRecipientSetIterator struct {
	Event *ArbOwnerFilteredFundsRecipientSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerFilteredFundsRecipientSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerFilteredFundsRecipientSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerFilteredFundsRecipientSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerFilteredFundsRecipientSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerFilteredFundsRecipientSet represents a FilteredFundsRecipientSet event raised by the ArbOwner contract.
type ArbOwnerFilteredFundsRecipientSet struct {
	NewRecipient common.Address
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterFilteredFundsRecipientSet is a free log retrieval operation binding the contract event 0x7446ff652b5056197ad963b644a1767e511137f4ea213dee4ce04e8ed08f9b9d.
//
// Solidity: event FilteredFundsRecipientSet(address indexed newRecipient)
func (_ArbOwner *ArbOwnerFilterer) FilterFilteredFundsRecipientSet(opts *bind.FilterOpts, newRecipient []common.Address) (*ArbOwnerFilteredFundsRecipientSetIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "FilteredFundsRecipientSet", newRecipientRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerFilteredFundsRecipientSetIterator{contract: _ArbOwner.contract, event: "FilteredFundsRecipientSet", logs: logs, sub: sub}, nil
}

// WatchFilteredFundsRecipientSet is a free log subscription operation binding the contract event 0x7446ff652b5056197ad963b644a1767e511137f4ea213dee4ce04e8ed08f9b9d.
//
// Solidity: event FilteredFundsRecipientSet(address indexed newRecipient)
func (_ArbOwner *ArbOwnerFilterer) WatchFilteredFundsRecipientSet(opts *bind.WatchOpts, sink chan<- *ArbOwnerFilteredFundsRecipientSet, newRecipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "FilteredFundsRecipientSet", newRecipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerFilteredFundsRecipientSet)
				if err := _ArbOwner.contract.UnpackLog(event, "FilteredFundsRecipientSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFilteredFundsRecipientSet is a log parse operation binding the contract event 0x7446ff652b5056197ad963b644a1767e511137f4ea213dee4ce04e8ed08f9b9d.
//
// Solidity: event FilteredFundsRecipientSet(address indexed newRecipient)
func (_ArbOwner *ArbOwnerFilterer) ParseFilteredFundsRecipientSet(log types.Log) (*ArbOwnerFilteredFundsRecipientSet, error) {
	event := new(ArbOwnerFilteredFundsRecipientSet)
	if err := _ArbOwner.contract.UnpackLog(event, "FilteredFundsRecipientSet", log); err != nil {
		return nil, err
	}
...
// ArbOwnerNativeTokenOwnerAddedIterator is returned from FilterNativeTokenOwnerAdded and is used to iterate over the raw logs and unpacked data for NativeTokenOwnerAdded events raised by the ArbOwner contract.
type ArbOwnerNativeTokenOwnerAddedIterator struct {
	Event *ArbOwnerNativeTokenOwnerAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerNativeTokenOwnerAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerNativeTokenOwnerAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerNativeTokenOwnerAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerNativeTokenOwnerAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerNativeTokenOwnerAdded represents a NativeTokenOwnerAdded event raised by the ArbOwner contract.
type ArbOwnerNativeTokenOwnerAdded struct {
	Owner common.Address
	Raw   types.Log // Blockchain specific contextual infos
}

// FilterNativeTokenOwnerAdded is a free log retrieval operation binding the contract event 0x9a6ac4819c7018655b5e0e2a1538a32f405355e698425cf6714914dcff06fa9e.
//
// Solidity: event NativeTokenOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) FilterNativeTokenOwnerAdded(opts *bind.FilterOpts, owner []common.Address) (*ArbOwnerNativeTokenOwnerAddedIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "NativeTokenOwnerAdded", ownerRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerNativeTokenOwnerAddedIterator{contract: _ArbOwner.contract, event: "NativeTokenOwnerAdded", logs: logs, sub: sub}, nil
}

// WatchNativeTokenOwnerAdded is a free log subscription operation binding the contract event 0x9a6ac4819c7018655b5e0e2a1538a32f405355e698425cf6714914dcff06fa9e.
//
// Solidity: event NativeTokenOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) WatchNativeTokenOwnerAdded(opts *bind.WatchOpts, sink chan<- *ArbOwnerNativeTokenOwnerAdded, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "NativeTokenOwnerAdded", ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerNativeTokenOwnerAdded)
				if err := _ArbOwner.contract.UnpackLog(event, "NativeTokenOwnerAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNativeTokenOwnerAdded is a log parse operation binding the contract event 0x9a6ac4819c7018655b5e0e2a1538a32f405355e698425cf6714914dcff06fa9e.
//
// Solidity: event NativeTokenOwnerAdded(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) ParseNativeTokenOwnerAdded(log types.Log) (*ArbOwnerNativeTokenOwnerAdded, error) {
	event := new(ArbOwnerNativeTokenOwnerAdded)
	if err := _ArbOwner.contract.UnpackLog(event, "NativeTokenOwnerAdded", log); err != nil {
		return nil, err
	}
...
// ArbOwnerNativeTokenOwnerRemovedIterator is returned from FilterNativeTokenOwnerRemoved and is used to iterate over the raw logs and unpacked data for NativeTokenOwnerRemoved events raised by the ArbOwner contract.
type ArbOwnerNativeTokenOwnerRemovedIterator struct {
	Event *ArbOwnerNativeTokenOwnerRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerNativeTokenOwnerRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerNativeTokenOwnerRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerNativeTokenOwnerRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerNativeTokenOwnerRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerNativeTokenOwnerRemoved represents a NativeTokenOwnerRemoved event raised by the ArbOwner contract.
type ArbOwnerNativeTokenOwnerRemoved struct {
	Owner common.Address
	Raw   types.Log // Blockchain specific contextual infos
}

// FilterNativeTokenOwnerRemoved is a free log retrieval operation binding the contract event 0x0862497be81c4801fbee18c876590d43ae844ec4c8413e53853a347cb759879a.
//
// Solidity: event NativeTokenOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) FilterNativeTokenOwnerRemoved(opts *bind.FilterOpts, owner []common.Address) (*ArbOwnerNativeTokenOwnerRemovedIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "NativeTokenOwnerRemoved", ownerRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerNativeTokenOwnerRemovedIterator{contract: _ArbOwner.contract, event: "NativeTokenOwnerRemoved", logs: logs, sub: sub}, nil
}

// WatchNativeTokenOwnerRemoved is a free log subscription operation binding the contract event 0x0862497be81c4801fbee18c876590d43ae844ec4c8413e53853a347cb759879a.
//
// Solidity: event NativeTokenOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) WatchNativeTokenOwnerRemoved(opts *bind.WatchOpts, sink chan<- *ArbOwnerNativeTokenOwnerRemoved, owner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "NativeTokenOwnerRemoved", ownerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerNativeTokenOwnerRemoved)
				if err := _ArbOwner.contract.UnpackLog(event, "NativeTokenOwnerRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNativeTokenOwnerRemoved is a log parse operation binding the contract event 0x0862497be81c4801fbee18c876590d43ae844ec4c8413e53853a347cb759879a.
//
// Solidity: event NativeTokenOwnerRemoved(address indexed owner)
func (_ArbOwner *ArbOwnerFilterer) ParseNativeTokenOwnerRemoved(log types.Log) (*ArbOwnerNativeTokenOwnerRemoved, error) {
	event := new(ArbOwnerNativeTokenOwnerRemoved)
	if err := _ArbOwner.contract.UnpackLog(event, "NativeTokenOwnerRemoved", log); err != nil {
		return nil, err
	}
...
// ArbOwnerTransactionFiltererAddedIterator is returned from FilterTransactionFiltererAdded and is used to iterate over the raw logs and unpacked data for TransactionFiltererAdded events raised by the ArbOwner contract.
type ArbOwnerTransactionFiltererAddedIterator struct {
	Event *ArbOwnerTransactionFiltererAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerTransactionFiltererAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerTransactionFiltererAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerTransactionFiltererAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerTransactionFiltererAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerTransactionFiltererAdded represents a TransactionFiltererAdded event raised by the ArbOwner contract.
type ArbOwnerTransactionFiltererAdded struct {
	Filterer common.Address
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterTransactionFiltererAdded is a free log retrieval operation binding the contract event 0x92c0896862dcf782b080661b3b1ab369f630b7cd4a68f1aa10ad27ba0b1a6aa1.
//
// Solidity: event TransactionFiltererAdded(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) FilterTransactionFiltererAdded(opts *bind.FilterOpts, filterer []common.Address) (*ArbOwnerTransactionFiltererAddedIterator, error) {

	var filtererRule []interface{}
	for _, filtererItem := range filterer {
		filtererRule = append(filtererRule, filtererItem)
	}

	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "TransactionFiltererAdded", filtererRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerTransactionFiltererAddedIterator{contract: _ArbOwner.contract, event: "TransactionFiltererAdded", logs: logs, sub: sub}, nil
}

// WatchTransactionFiltererAdded is a free log subscription operation binding the contract event 0x92c0896862dcf782b080661b3b1ab369f630b7cd4a68f1aa10ad27ba0b1a6aa1.
//
// Solidity: event TransactionFiltererAdded(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) WatchTransactionFiltererAdded(opts *bind.WatchOpts, sink chan<- *ArbOwnerTransactionFiltererAdded, filterer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "TransactionFiltererAdded", filtererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerTransactionFiltererAdded)
				if err := _ArbOwner.contract.UnpackLog(event, "TransactionFiltererAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTransactionFiltererAdded is a log parse operation binding the contract event 0x92c0896862dcf782b080661b3b1ab369f630b7cd4a68f1aa10ad27ba0b1a6aa1.
//
// Solidity: event TransactionFiltererAdded(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) ParseTransactionFiltererAdded(log types.Log) (*ArbOwnerTransactionFiltererAdded, error) {
	event := new(ArbOwnerTransactionFiltererAdded)
	if err := _ArbOwner.contract.UnpackLog(event, "TransactionFiltererAdded", log); err != nil {
		return nil, err
	}
...
// ArbOwnerTransactionFiltererRemovedIterator is returned from FilterTransactionFiltererRemoved and is used to iterate over the raw logs and unpacked data for TransactionFiltererRemoved events raised by the ArbOwner contract.
type ArbOwnerTransactionFiltererRemovedIterator struct {
	Event *ArbOwnerTransactionFiltererRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbOwnerTransactionFiltererRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbOwnerTransactionFiltererRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbOwnerTransactionFiltererRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbOwnerTransactionFiltererRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbOwnerTransactionFiltererRemoved represents a TransactionFiltererRemoved event raised by the ArbOwner contract.
type ArbOwnerTransactionFiltererRemoved struct {
	Filterer common.Address
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterTransactionFiltererRemoved is a free log retrieval operation binding the contract event 0xdbd02dacac4eee42611d0b4f3cc8909cf61c742a8509b771220eaab21638fb14.
//
// Solidity: event TransactionFiltererRemoved(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) FilterTransactionFiltererRemoved(opts *bind.FilterOpts, filterer []common.Address) (*ArbOwnerTransactionFiltererRemovedIterator, error) {
	...
	logs, sub, err := _ArbOwner.contract.FilterLogs(opts, "TransactionFiltererRemoved", filtererRule)
	if err != nil {
		return nil, err
	}
	return &ArbOwnerTransactionFiltererRemovedIterator{contract: _ArbOwner.contract, event: "TransactionFiltererRemoved", logs: logs, sub: sub}, nil
}

// WatchTransactionFiltererRemoved is a free log subscription operation binding the contract event 0xdbd02dacac4eee42611d0b4f3cc8909cf61c742a8509b771220eaab21638fb14.
//
// Solidity: event TransactionFiltererRemoved(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) WatchTransactionFiltererRemoved(opts *bind.WatchOpts, sink chan<- *ArbOwnerTransactionFiltererRemoved, filterer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbOwner.contract.WatchLogs(opts, "TransactionFiltererRemoved", filtererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbOwnerTransactionFiltererRemoved)
				if err := _ArbOwner.contract.UnpackLog(event, "TransactionFiltererRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTransactionFiltererRemoved is a log parse operation binding the contract event 0xdbd02dacac4eee42611d0b4f3cc8909cf61c742a8509b771220eaab21638fb14.
//
// Solidity: event TransactionFiltererRemoved(address indexed filterer)
func (_ArbOwner *ArbOwnerFilterer) ParseTransactionFiltererRemoved(log types.Log) (*ArbOwnerTransactionFiltererRemoved, error) {
	event := new(ArbOwnerTransactionFiltererRemoved)
	if err := _ArbOwner.contract.UnpackLog(event, "TransactionFiltererRemoved", log); err != nil {
		return nil, err
	}
...
var ArbOwnerPublicMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"getAllChainOwners\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllNativeTokenOwners\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getAllTransactionFilterers\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getBrotliCompressionLevel\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getCollectTips\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getFilteredFundsRecipient\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getInfraFeeAccount\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getMaxStylusContractFragments\",\"outputs\":[{\"internalType\":\"uint8\",\"name\":\"\",\"type\":\"uint8\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getNativeTokenManagementFrom\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getNetworkFeeAccount\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getParentGasFloorPerToken\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getScheduledUpgrade\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"arbosVersion\",\"type\":\"uint64\"},{\"internalType\":\"uint64\",\"name\":\"scheduledForTimestamp\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getTransactionFilteringFrom\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"isCalldataPriceIncreaseEnabled\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"isChainOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"isNativeTokenOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"filterer\",\"type\":\"address\"}],\"name\":\"isTransactionFilterer\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"ownerToRectify\",\"type\":\"address\"}],\"name\":\"rectifyChainOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"rectifiedOwner\",\"type\":\"address\"}],\"name\":\"ChainOwnerRectified\",\"type\":\"event\"}]",
}
...
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetAllTransactionFilterers(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getAllTransactionFilterers")
...
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetAllTransactionFilterers() ([]common.Address, error) {
	return _ArbOwnerPublic.Contract.GetAllTransactionFilterers(&_ArbOwnerPublic.CallOpts)
}

// GetAllTransactionFilterers is a free data retrieval call binding the contract method 0x595fbb5a.
//
// Solidity: function getAllTransactionFilterers() view returns(address[])
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetAllTransactionFilterers() ([]common.Address, error) {
	return _ArbOwnerPublic.Contract.GetAllTransactionFilterers(&_ArbOwnerPublic.CallOpts)
}
...
// GetCollectTips is a free data retrieval call binding the contract method 0x8e34a64d.
//
// Solidity: function getCollectTips() view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetCollectTips(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getCollectTips")
...
//
// Solidity: function getCollectTips() view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetCollectTips() (bool, error) {
	return _ArbOwnerPublic.Contract.GetCollectTips(&_ArbOwnerPublic.CallOpts)
}

// GetCollectTips is a free data retrieval call binding the contract method 0x8e34a64d.
//
// Solidity: function getCollectTips() view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetCollectTips() (bool, error) {
	return _ArbOwnerPublic.Contract.GetCollectTips(&_ArbOwnerPublic.CallOpts)
}
...
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetFilteredFundsRecipient(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getFilteredFundsRecipient")
...
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetFilteredFundsRecipient() (common.Address, error) {
	return _ArbOwnerPublic.Contract.GetFilteredFundsRecipient(&_ArbOwnerPublic.CallOpts)
}

// GetFilteredFundsRecipient is a free data retrieval call binding the contract method 0x3caa5f12.
//
// Solidity: function getFilteredFundsRecipient() view returns(address)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetFilteredFundsRecipient() (common.Address, error) {
	return _ArbOwnerPublic.Contract.GetFilteredFundsRecipient(&_ArbOwnerPublic.CallOpts)
}
...
// GetMaxStylusContractFragments is a free data retrieval call binding the contract method 0xe5a7f893.
//
// Solidity: function getMaxStylusContractFragments() view returns(uint8)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetMaxStylusContractFragments(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getMaxStylusContractFragments")
...
//
// Solidity: function getMaxStylusContractFragments() view returns(uint8)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetMaxStylusContractFragments() (uint8, error) {
	return _ArbOwnerPublic.Contract.GetMaxStylusContractFragments(&_ArbOwnerPublic.CallOpts)
}

// GetMaxStylusContractFragments is a free data retrieval call binding the contract method 0xe5a7f893.
//
// Solidity: function getMaxStylusContractFragments() view returns(uint8)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetMaxStylusContractFragments() (uint8, error) {
	return _ArbOwnerPublic.Contract.GetMaxStylusContractFragments(&_ArbOwnerPublic.CallOpts)
}

// GetNativeTokenManagementFrom is a free data retrieval call binding the contract method 0x3fecbab0.
//
// Solidity: function getNativeTokenManagementFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetNativeTokenManagementFrom(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getNativeTokenManagementFrom")
...
//
// Solidity: function getNativeTokenManagementFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetNativeTokenManagementFrom() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetNativeTokenManagementFrom(&_ArbOwnerPublic.CallOpts)
}

// GetNativeTokenManagementFrom is a free data retrieval call binding the contract method 0x3fecbab0.
//
// Solidity: function getNativeTokenManagementFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetNativeTokenManagementFrom() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetNativeTokenManagementFrom(&_ArbOwnerPublic.CallOpts)
}
...
// GetParentGasFloorPerToken is a free data retrieval call binding the contract method 0x49ccdaff.
//
// Solidity: function getParentGasFloorPerToken() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetParentGasFloorPerToken(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getParentGasFloorPerToken")
...
//
// Solidity: function getParentGasFloorPerToken() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetParentGasFloorPerToken() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetParentGasFloorPerToken(&_ArbOwnerPublic.CallOpts)
}

// GetParentGasFloorPerToken is a free data retrieval call binding the contract method 0x49ccdaff.
//
// Solidity: function getParentGasFloorPerToken() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetParentGasFloorPerToken() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetParentGasFloorPerToken(&_ArbOwnerPublic.CallOpts)
}
...
// GetTransactionFilteringFrom is a free data retrieval call binding the contract method 0xc1d355b8.
//
// Solidity: function getTransactionFilteringFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) GetTransactionFilteringFrom(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "getTransactionFilteringFrom")
...
//
// Solidity: function getTransactionFilteringFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicSession) GetTransactionFilteringFrom() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetTransactionFilteringFrom(&_ArbOwnerPublic.CallOpts)
}

// GetTransactionFilteringFrom is a free data retrieval call binding the contract method 0xc1d355b8.
//
// Solidity: function getTransactionFilteringFrom() view returns(uint64)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) GetTransactionFilteringFrom() (uint64, error) {
	return _ArbOwnerPublic.Contract.GetTransactionFilteringFrom(&_ArbOwnerPublic.CallOpts)
}
...
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicCaller) IsTransactionFilterer(opts *bind.CallOpts, filterer common.Address) (bool, error) {
	var out []interface{}
	err := _ArbOwnerPublic.contract.Call(opts, &out, "isTransactionFilterer", filterer)
...
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicSession) IsTransactionFilterer(filterer common.Address) (bool, error) {
	return _ArbOwnerPublic.Contract.IsTransactionFilterer(&_ArbOwnerPublic.CallOpts, filterer)
}

// IsTransactionFilterer is a free data retrieval call binding the contract method 0xb32352c3.
//
// Solidity: function isTransactionFilterer(address filterer) view returns(bool)
func (_ArbOwnerPublic *ArbOwnerPublicCallerSession) IsTransactionFilterer(filterer common.Address) (bool, error) {
	return _ArbOwnerPublic.Contract.IsTransactionFilterer(&_ArbOwnerPublic.CallOpts, filterer)
}
...
// ActivationGas is a free data retrieval call binding the contract method 0x2278c278.
//
// Solidity: function activationGas() view returns(uint64 gas)
func (_ArbWasm *ArbWasmCaller) ActivationGas(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ArbWasm.contract.Call(opts, &out, "activationGas")
...
//
// Solidity: function activationGas() view returns(uint64 gas)
func (_ArbWasm *ArbWasmSession) ActivationGas() (uint64, error) {
	return _ArbWasm.Contract.ActivationGas(&_ArbWasm.CallOpts)
}

// ActivationGas is a free data retrieval call binding the contract method 0x2278c278.
//
// Solidity: function activationGas() view returns(uint64 gas)
func (_ArbWasm *ArbWasmCallerSession) ActivationGas() (uint64, error) {
	return _ArbWasm.Contract.ActivationGas(&_ArbWasm.CallOpts)
}
...
// BatchPostingReportV2 is a paid mutator transaction binding the contract method 0x9998269e.
//
// Solidity: function batchPostingReportV2(uint256 batchTimestamp, address batchPosterAddress, uint64 batchNumber, uint64 batchCalldataLength, uint64 batchCalldataNonZeros, uint64 batchExtraGas, uint256 l1BaseFeeWei) returns()
func (_ArbosActs *ArbosActsTransactor) BatchPostingReportV2(opts *bind.TransactOpts, batchTimestamp *big.Int, batchPosterAddress common.Address, batchNumber uint64, batchCalldataLength uint64, batchCalldataNonZeros uint64, batchExtraGas uint64, l1BaseFeeWei *big.Int) (*types.Transaction, error) {
	return _ArbosActs.contract.Transact(opts, "batchPostingReportV2", batchTimestamp, batchPosterAddress, batchNumber, batchCalldataLength, batchCalldataNonZeros, batchExtraGas, l1BaseFeeWei)
}

// BatchPostingReportV2 is a paid mutator transaction binding the contract method 0x9998269e.
//
// Solidity: function batchPostingReportV2(uint256 batchTimestamp, address batchPosterAddress, uint64 batchNumber, uint64 batchCalldataLength, uint64 batchCalldataNonZeros, uint64 batchExtraGas, uint256 l1BaseFeeWei) returns()
func (_ArbosActs *ArbosActsSession) BatchPostingReportV2(batchTimestamp *big.Int, batchPosterAddress common.Address, batchNumber uint64, batchCalldataLength uint64, batchCalldataNonZeros uint64, batchExtraGas uint64, l1BaseFeeWei *big.Int) (*types.Transaction, error) {
	return _ArbosActs.Contract.BatchPostingReportV2(&_ArbosActs.TransactOpts, batchTimestamp, batchPosterAddress, batchNumber, batchCalldataLength, batchCalldataNonZeros, batchExtraGas, l1BaseFeeWei)
}

// BatchPostingReportV2 is a paid mutator transaction binding the contract method 0x9998269e.
//
// Solidity: function batchPostingReportV2(uint256 batchTimestamp, address batchPosterAddress, uint64 batchNumber, uint64 batchCalldataLength, uint64 batchCalldataNonZeros, uint64 batchExtraGas, uint256 l1BaseFeeWei) returns()
func (_ArbosActs *ArbosActsTransactorSession) BatchPostingReportV2(batchTimestamp *big.Int, batchPosterAddress common.Address, batchNumber uint64, batchCalldataLength uint64, batchCalldataNonZeros uint64, batchExtraGas uint64, l1BaseFeeWei *big.Int) (*types.Transaction, error) {
	return _ArbosActs.Contract.BatchPostingReportV2(&_ArbosActs.TransactOpts, batchTimestamp, batchPosterAddress, batchNumber, batchCalldataLength, batchCalldataNonZeros, batchExtraGas, l1BaseFeeWei)
}
