...
func (_IFallbackManager *IFallbackManagerTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _IFallbackManager.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_IFallbackManager *IFallbackManagerSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _IFallbackManager.Contract.Fallback(&_IFallbackManager.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_IFallbackManager *IFallbackManagerTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _IFallbackManager.Contract.Fallback(&_IFallbackManager.TransactOpts, calldata)
}
...
// INativeCurrencyPaymentFallbackMetaData contains all meta data concerning the INativeCurrencyPaymentFallback contract.
var INativeCurrencyPaymentFallbackMetaData = &bind.MetaData{
...
// INativeCurrencyPaymentFallbackABI is the input ABI used to generate the binding from.
// Deprecated: Use INativeCurrencyPaymentFallbackMetaData.ABI instead.
var INativeCurrencyPaymentFallbackABI = INativeCurrencyPaymentFallbackMetaData.ABI

// INativeCurrencyPaymentFallback is an auto generated Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallback struct {
	INativeCurrencyPaymentFallbackCaller     // Read-only binding to the contract
	INativeCurrencyPaymentFallbackTransactor // Write-only binding to the contract
	INativeCurrencyPaymentFallbackFilterer   // Log filterer for contract events
}

// INativeCurrencyPaymentFallbackCaller is an auto generated read-only Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallbackCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// INativeCurrencyPaymentFallbackTransactor is an auto generated write-only Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallbackTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// INativeCurrencyPaymentFallbackFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type INativeCurrencyPaymentFallbackFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// INativeCurrencyPaymentFallbackSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type INativeCurrencyPaymentFallbackSession struct {
	Contract     *INativeCurrencyPaymentFallback // Generic contract binding to set the session for
	CallOpts     bind.CallOpts                   // Call options to use throughout this session
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// INativeCurrencyPaymentFallbackCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type INativeCurrencyPaymentFallbackCallerSession struct {
	Contract *INativeCurrencyPaymentFallbackCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                         // Call options to use throughout this session
}

// INativeCurrencyPaymentFallbackTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type INativeCurrencyPaymentFallbackTransactorSession struct {
	Contract     *INativeCurrencyPaymentFallbackTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                         // Transaction auth options to use throughout this session
}

// INativeCurrencyPaymentFallbackRaw is an auto generated low-level Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallbackRaw struct {
	Contract *INativeCurrencyPaymentFallback // Generic contract binding to access the raw methods on
}

// INativeCurrencyPaymentFallbackCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallbackCallerRaw struct {
	Contract *INativeCurrencyPaymentFallbackCaller // Generic read-only contract binding to access the raw methods on
}

// INativeCurrencyPaymentFallbackTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type INativeCurrencyPaymentFallbackTransactorRaw struct {
	Contract *INativeCurrencyPaymentFallbackTransactor // Generic write-only contract binding to access the raw methods on
}

// NewINativeCurrencyPaymentFallback creates a new instance of INativeCurrencyPaymentFallback, bound to a specific deployed contract.
func NewINativeCurrencyPaymentFallback(address common.Address, backend bind.ContractBackend) (*INativeCurrencyPaymentFallback, error) {
	contract, err := bindINativeCurrencyPaymentFallback(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &INativeCurrencyPaymentFallback{INativeCurrencyPaymentFallbackCaller: INativeCurrencyPaymentFallbackCaller{contract: contract}, INativeCurrencyPaymentFallbackTransactor: INativeCurrencyPaymentFallbackTransactor{contract: contract}, INativeCurrencyPaymentFallbackFilterer: INativeCurrencyPaymentFallbackFilterer{contract: contract}}, nil
}

// NewINativeCurrencyPaymentFallbackCaller creates a new read-only instance of INativeCurrencyPaymentFallback, bound to a specific deployed contract.
func NewINativeCurrencyPaymentFallbackCaller(address common.Address, caller bind.ContractCaller) (*INativeCurrencyPaymentFallbackCaller, error) {
	contract, err := bindINativeCurrencyPaymentFallback(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &INativeCurrencyPaymentFallbackCaller{contract: contract}, nil
}

// NewINativeCurrencyPaymentFallbackTransactor creates a new write-only instance of INativeCurrencyPaymentFallback, bound to a specific deployed contract.
func NewINativeCurrencyPaymentFallbackTransactor(address common.Address, transactor bind.ContractTransactor) (*INativeCurrencyPaymentFallbackTransactor, error) {
	contract, err := bindINativeCurrencyPaymentFallback(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &INativeCurrencyPaymentFallbackTransactor{contract: contract}, nil
}

// NewINativeCurrencyPaymentFallbackFilterer creates a new log filterer instance of INativeCurrencyPaymentFallback, bound to a specific deployed contract.
func NewINativeCurrencyPaymentFallbackFilterer(address common.Address, filterer bind.ContractFilterer) (*INativeCurrencyPaymentFallbackFilterer, error) {
	contract, err := bindINativeCurrencyPaymentFallback(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &INativeCurrencyPaymentFallbackFilterer{contract: contract}, nil
}

// bindINativeCurrencyPaymentFallback binds a generic wrapper to an already deployed contract.
func bindINativeCurrencyPaymentFallback(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := INativeCurrencyPaymentFallbackMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	return bind.NewBoundContract(address, *parsed, caller, transactor, filterer), nil
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _INativeCurrencyPaymentFallback.Contract.INativeCurrencyPaymentFallbackCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.INativeCurrencyPaymentFallbackTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.INativeCurrencyPaymentFallbackTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _INativeCurrencyPaymentFallback.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.contract.Transact(opts, method, params...)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackSession) Receive() (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.Receive(&_INativeCurrencyPaymentFallback.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackTransactorSession) Receive() (*types.Transaction, error) {
	return _INativeCurrencyPaymentFallback.Contract.Receive(&_INativeCurrencyPaymentFallback.TransactOpts)
}

// INativeCurrencyPaymentFallbackSafeReceivedIterator is returned from FilterSafeReceived and is used to iterate over the raw logs and unpacked data for SafeReceived events raised by the INativeCurrencyPaymentFallback contract.
type INativeCurrencyPaymentFallbackSafeReceivedIterator struct {
	Event *INativeCurrencyPaymentFallbackSafeReceived // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *INativeCurrencyPaymentFallbackSafeReceivedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(INativeCurrencyPaymentFallbackSafeReceived)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *INativeCurrencyPaymentFallbackSafeReceivedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *INativeCurrencyPaymentFallbackSafeReceivedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// INativeCurrencyPaymentFallbackSafeReceived represents a SafeReceived event raised by the INativeCurrencyPaymentFallback contract.
type INativeCurrencyPaymentFallbackSafeReceived struct {
...
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackFilterer) FilterSafeReceived(opts *bind.FilterOpts, sender []common.Address) (*INativeCurrencyPaymentFallbackSafeReceivedIterator, error) {
	...
	logs, sub, err := _INativeCurrencyPaymentFallback.contract.FilterLogs(opts, "SafeReceived", senderRule)
	if err != nil {
		return nil, err
	}
	return &INativeCurrencyPaymentFallbackSafeReceivedIterator{contract: _INativeCurrencyPaymentFallback.contract, event: "SafeReceived", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SafeReceived(address indexed sender, uint256 value)
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackFilterer) WatchSafeReceived(opts *bind.WatchOpts, sink chan<- *INativeCurrencyPaymentFallbackSafeReceived, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _INativeCurrencyPaymentFallback.contract.WatchLogs(opts, "SafeReceived", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(INativeCurrencyPaymentFallbackSafeReceived)
				if err := _INativeCurrencyPaymentFallback.contract.UnpackLog(event, "SafeReceived", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SafeReceived(address indexed sender, uint256 value)
func (_INativeCurrencyPaymentFallback *INativeCurrencyPaymentFallbackFilterer) ParseSafeReceived(log types.Log) (*INativeCurrencyPaymentFallbackSafeReceived, error) {
	event := new(INativeCurrencyPaymentFallbackSafeReceived)
	if err := _INativeCurrencyPaymentFallback.contract.UnpackLog(event, "SafeReceived", log); err != nil {
		return nil, err
	}
...
// CheckSignatures is a free data retrieval call binding the contract method 0xf855438b.
//
// Solidity: function checkSignatures(address executor, bytes32 dataHash, bytes signatures) view returns()
func (_ISafe *ISafeCaller) CheckSignatures(opts *bind.CallOpts, executor common.Address, dataHash [32]byte, signatures []byte) error {
	var out []interface{}
	err := _ISafe.contract.Call(opts, &out, "checkSignatures", executor, dataHash, signatures)
...
//
// Solidity: function checkSignatures(address executor, bytes32 dataHash, bytes signatures) view returns()
func (_ISafe *ISafeSession) CheckSignatures(executor common.Address, dataHash [32]byte, signatures []byte) error {
	return _ISafe.Contract.CheckSignatures(&_ISafe.CallOpts, executor, dataHash, signatures)
}

// CheckSignatures is a free data retrieval call binding the contract method 0xf855438b.
//
// Solidity: function checkSignatures(address executor, bytes32 dataHash, bytes signatures) view returns()
func (_ISafe *ISafeCallerSession) CheckSignatures(executor common.Address, dataHash [32]byte, signatures []byte) error {
	return _ISafe.Contract.CheckSignatures(&_ISafe.CallOpts, executor, dataHash, signatures)
}
...
func (_ISafe *ISafeCaller) GetStorageAt(opts *bind.CallOpts, offset *big.Int, length *big.Int) ([]byte, error) {
	var out []interface{}
	err := _ISafe.contract.Call(opts, &out, "getStorageAt", offset, length)
...
//
// Solidity: function getStorageAt(uint256 offset, uint256 length) view returns(bytes)
func (_ISafe *ISafeSession) GetStorageAt(offset *big.Int, length *big.Int) ([]byte, error) {
	return _ISafe.Contract.GetStorageAt(&_ISafe.CallOpts, offset, length)
}

// GetStorageAt is a free data retrieval call binding the contract method 0x5624b25b.
//
// Solidity: function getStorageAt(uint256 offset, uint256 length) view returns(bytes)
func (_ISafe *ISafeCallerSession) GetStorageAt(offset *big.Int, length *big.Int) ([]byte, error) {
	return _ISafe.Contract.GetStorageAt(&_ISafe.CallOpts, offset, length)
}
...
func (_ISafe *ISafeTransactor) SimulateAndRevert(opts *bind.TransactOpts, targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _ISafe.contract.Transact(opts, "simulateAndRevert", targetContract, calldataPayload)
}

// SimulateAndRevert is a paid mutator transaction binding the contract method 0xb4faba09.
//
// Solidity: function simulateAndRevert(address targetContract, bytes calldataPayload) returns()
func (_ISafe *ISafeSession) SimulateAndRevert(targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _ISafe.Contract.SimulateAndRevert(&_ISafe.TransactOpts, targetContract, calldataPayload)
}

// SimulateAndRevert is a paid mutator transaction binding the contract method 0xb4faba09.
//
// Solidity: function simulateAndRevert(address targetContract, bytes calldataPayload) returns()
func (_ISafe *ISafeTransactorSession) SimulateAndRevert(targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _ISafe.Contract.SimulateAndRevert(&_ISafe.TransactOpts, targetContract, calldataPayload)
}
...
//
// Solidity: fallback() returns()
func (_ISafe *ISafeTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _ISafe.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_ISafe *ISafeSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _ISafe.Contract.Fallback(&_ISafe.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() returns()
func (_ISafe *ISafeTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _ISafe.Contract.Fallback(&_ISafe.TransactOpts, calldata)
}
...
//
// Solidity: receive() payable returns()
func (_ISafe *ISafeTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ISafe.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_ISafe *ISafeSession) Receive() (*types.Transaction, error) {
	return _ISafe.Contract.Receive(&_ISafe.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_ISafe *ISafeTransactorSession) Receive() (*types.Transaction, error) {
	return _ISafe.Contract.Receive(&_ISafe.TransactOpts)
}
...
// ISafeSafeReceivedIterator is returned from FilterSafeReceived and is used to iterate over the raw logs and unpacked data for SafeReceived events raised by the ISafe contract.
type ISafeSafeReceivedIterator struct {
	Event *ISafeSafeReceived // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ISafeSafeReceivedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ISafeSafeReceived)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ISafeSafeReceivedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ISafeSafeReceivedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ISafeSafeReceived represents a SafeReceived event raised by the ISafe contract.
type ISafeSafeReceived struct {
	Sender common.Address
	Value  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event SafeReceived(address indexed sender, uint256 value)
func (_ISafe *ISafeFilterer) FilterSafeReceived(opts *bind.FilterOpts, sender []common.Address) (*ISafeSafeReceivedIterator, error) {
	...
	logs, sub, err := _ISafe.contract.FilterLogs(opts, "SafeReceived", senderRule)
	if err != nil {
		return nil, err
	}
	return &ISafeSafeReceivedIterator{contract: _ISafe.contract, event: "SafeReceived", logs: logs, sub: sub}, nil
}

// WatchSafeReceived is a free log subscription operation binding the contract event 0x3d0ce9bfc3ed7d6862dbb28b2dea94561fe714a1b4d019aa8af39730d1ad7c3d.
//
// Solidity: event SafeReceived(address indexed sender, uint256 value)
func (_ISafe *ISafeFilterer) WatchSafeReceived(opts *bind.WatchOpts, sink chan<- *ISafeSafeReceived, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ISafe.contract.WatchLogs(opts, "SafeReceived", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ISafeSafeReceived)
				if err := _ISafe.contract.UnpackLog(event, "SafeReceived", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SafeReceived(address indexed sender, uint256 value)
func (_ISafe *ISafeFilterer) ParseSafeReceived(log types.Log) (*ISafeSafeReceived, error) {
	event := new(ISafeSafeReceived)
	if err := _ISafe.contract.UnpackLog(event, "SafeReceived", log); err != nil {
		return nil, err
	}
...
// IStorageAccessibleMetaData contains all meta data concerning the IStorageAccessible contract.
var IStorageAccessibleMetaData = &bind.MetaData{
...
// IStorageAccessibleABI is the input ABI used to generate the binding from.
// Deprecated: Use IStorageAccessibleMetaData.ABI instead.
var IStorageAccessibleABI = IStorageAccessibleMetaData.ABI

// IStorageAccessible is an auto generated Go binding around an Ethereum contract.
type IStorageAccessible struct {
	IStorageAccessibleCaller     // Read-only binding to the contract
	IStorageAccessibleTransactor // Write-only binding to the contract
	IStorageAccessibleFilterer   // Log filterer for contract events
}

// IStorageAccessibleCaller is an auto generated read-only Go binding around an Ethereum contract.
type IStorageAccessibleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IStorageAccessibleTransactor is an auto generated write-only Go binding around an Ethereum contract.
type IStorageAccessibleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IStorageAccessibleFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type IStorageAccessibleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IStorageAccessibleSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type IStorageAccessibleSession struct {
	Contract     *IStorageAccessible // Generic contract binding to set the session for
	CallOpts     bind.CallOpts       // Call options to use throughout this session
	TransactOpts bind.TransactOpts   // Transaction auth options to use throughout this session
}

// IStorageAccessibleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type IStorageAccessibleCallerSession struct {
	Contract *IStorageAccessibleCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts             // Call options to use throughout this session
}

// IStorageAccessibleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type IStorageAccessibleTransactorSession struct {
	Contract     *IStorageAccessibleTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts             // Transaction auth options to use throughout this session
}

// IStorageAccessibleRaw is an auto generated low-level Go binding around an Ethereum contract.
type IStorageAccessibleRaw struct {
	Contract *IStorageAccessible // Generic contract binding to access the raw methods on
}

// IStorageAccessibleCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type IStorageAccessibleCallerRaw struct {
	Contract *IStorageAccessibleCaller // Generic read-only contract binding to access the raw methods on
}

// IStorageAccessibleTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type IStorageAccessibleTransactorRaw struct {
	Contract *IStorageAccessibleTransactor // Generic write-only contract binding to access the raw methods on
}

// NewIStorageAccessible creates a new instance of IStorageAccessible, bound to a specific deployed contract.
func NewIStorageAccessible(address common.Address, backend bind.ContractBackend) (*IStorageAccessible, error) {
	contract, err := bindIStorageAccessible(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &IStorageAccessible{IStorageAccessibleCaller: IStorageAccessibleCaller{contract: contract}, IStorageAccessibleTransactor: IStorageAccessibleTransactor{contract: contract}, IStorageAccessibleFilterer: IStorageAccessibleFilterer{contract: contract}}, nil
}

// NewIStorageAccessibleCaller creates a new read-only instance of IStorageAccessible, bound to a specific deployed contract.
func NewIStorageAccessibleCaller(address common.Address, caller bind.ContractCaller) (*IStorageAccessibleCaller, error) {
	contract, err := bindIStorageAccessible(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &IStorageAccessibleCaller{contract: contract}, nil
}

// NewIStorageAccessibleTransactor creates a new write-only instance of IStorageAccessible, bound to a specific deployed contract.
func NewIStorageAccessibleTransactor(address common.Address, transactor bind.ContractTransactor) (*IStorageAccessibleTransactor, error) {
	contract, err := bindIStorageAccessible(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &IStorageAccessibleTransactor{contract: contract}, nil
}

// NewIStorageAccessibleFilterer creates a new log filterer instance of IStorageAccessible, bound to a specific deployed contract.
func NewIStorageAccessibleFilterer(address common.Address, filterer bind.ContractFilterer) (*IStorageAccessibleFilterer, error) {
	contract, err := bindIStorageAccessible(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &IStorageAccessibleFilterer{contract: contract}, nil
}

// bindIStorageAccessible binds a generic wrapper to an already deployed contract.
func bindIStorageAccessible(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := IStorageAccessibleMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
	return bind.NewBoundContract(address, *parsed, caller, transactor, filterer), nil
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_IStorageAccessible *IStorageAccessibleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _IStorageAccessible.Contract.IStorageAccessibleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_IStorageAccessible *IStorageAccessibleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.IStorageAccessibleTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IStorageAccessible *IStorageAccessibleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.IStorageAccessibleTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_IStorageAccessible *IStorageAccessibleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _IStorageAccessible.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_IStorageAccessible *IStorageAccessibleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IStorageAccessible *IStorageAccessibleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.contract.Transact(opts, method, params...)
}

// GetStorageAt is a free data retrieval call binding the contract method 0x5624b25b.
//
// Solidity: function getStorageAt(uint256 offset, uint256 length) view returns(bytes)
func (_IStorageAccessible *IStorageAccessibleCaller) GetStorageAt(opts *bind.CallOpts, offset *big.Int, length *big.Int) ([]byte, error) {
	var out []interface{}
	err := _IStorageAccessible.contract.Call(opts, &out, "getStorageAt", offset, length)
...
//
// Solidity: function getStorageAt(uint256 offset, uint256 length) view returns(bytes)
func (_IStorageAccessible *IStorageAccessibleSession) GetStorageAt(offset *big.Int, length *big.Int) ([]byte, error) {
	return _IStorageAccessible.Contract.GetStorageAt(&_IStorageAccessible.CallOpts, offset, length)
}

// GetStorageAt is a free data retrieval call binding the contract method 0x5624b25b.
//
// Solidity: function getStorageAt(uint256 offset, uint256 length) view returns(bytes)
func (_IStorageAccessible *IStorageAccessibleCallerSession) GetStorageAt(offset *big.Int, length *big.Int) ([]byte, error) {
	return _IStorageAccessible.Contract.GetStorageAt(&_IStorageAccessible.CallOpts, offset, length)
}
...
//
// Solidity: function simulateAndRevert(address targetContract, bytes calldataPayload) returns()
func (_IStorageAccessible *IStorageAccessibleTransactor) SimulateAndRevert(opts *bind.TransactOpts, targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _IStorageAccessible.contract.Transact(opts, "simulateAndRevert", targetContract, calldataPayload)
}

// SimulateAndRevert is a paid mutator transaction binding the contract method 0xb4faba09.
//
// Solidity: function simulateAndRevert(address targetContract, bytes calldataPayload) returns()
func (_IStorageAccessible *IStorageAccessibleSession) SimulateAndRevert(targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.SimulateAndRevert(&_IStorageAccessible.TransactOpts, targetContract, calldataPayload)
}

// SimulateAndRevert is a paid mutator transaction binding the contract method 0xb4faba09.
//
// Solidity: function simulateAndRevert(address targetContract, bytes calldataPayload) returns()
func (_IStorageAccessible *IStorageAccessibleTransactorSession) SimulateAndRevert(targetContract common.Address, calldataPayload []byte) (*types.Transaction, error) {
	return _IStorageAccessible.Contract.SimulateAndRevert(&_IStorageAccessible.TransactOpts, targetContract, calldataPayload)
}
