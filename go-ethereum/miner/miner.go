...
func (miner *Miner) getPending() *newPayloadResult {
	...
	if miner.chainConfig.IsShanghai(new(big.Int).Add(header.Number, big.NewInt(1)), timestamp, types.DeserializeHeaderExtraInformation(header).ArbOSFormatVersion) {
