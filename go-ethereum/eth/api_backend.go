...
import (
	...
	"github.com/tenderly/net-nitro/go-ethereum/core/txpool/locals"
...
func (b *EthAPIBackend) GetEVM(ctx context.Context, state vm.StateDB, header *types.Header, vmConfig *vm.Config, blockCtx *vm.BlockContext) *vm.EVM {
	if vmConfig == nil {
