...
import (
	...
	"github.com/tenderly/net-nitro/go-ethereum/crypto/signify"
	"github.com/tenderly/net-nitro/go-ethereum/notinternal/build"
	"github.com/tenderly/net-nitro/go-ethereum/notinternal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-nitro/go-ethereum/notinternal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-nitro/go-ethereum/notinternal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-nitro/go-ethereum/core/rawdb", "github.com/tenderly/net-nitro/go-ethereum/ethdb/leveldb"},
		{"github.com/tenderly/net-nitro/go-ethereum/core/rawdb", "github.com/tenderly/net-nitro/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
