...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/tenderly/net-nitro/go-ethereum/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/tenderly/net-nitro/go-ethereum/pull/23274
...
func (args *TransactionArgs) ToMessage(baseFee *big.Int, globalGasCap uint64, header *types.Header, state vm.StateDB, runMode core.MessageRunMode, skipNonceCheck, skipEoACheck bool) *core.Message {
	var (
		gasPrice  *big.Int
		gasFeeCap *big.Int
		gasTipCap *big.Int
