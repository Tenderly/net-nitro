...
// Package tree includes logic for keeping track of royal edges within a challenge
...
func (ht *RoyalChallengeTree) findClaimingEdge(claimedEdge protocol.EdgeId) (protocol.SpecEdge, bool) {
