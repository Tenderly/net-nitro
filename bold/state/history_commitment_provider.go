...
func (p *HistoryCommitmentProvider) historyCommitmentImpl(
	...
	defer func() {
		...
		// bold.
		// Eg https://github.com/tenderly/net-nitro/blob/ab6790a9e33884c3b4e81de2a97dae5bf904266e/das/restful_server.go#L30
...
func (p *HistoryCommitmentProvider) PrefixProof(
	...
	// safety-check.
	if err = prefix.VerifyPrefixProof(&prefix.VerifyPrefixProofConfig{
		PreRoot:      prefixRoot,
